...
This is the modified LinkedList class that will be used for this project. implements List<E> and extends AbstractList<E>
...
public class LinkedList<E> extends AbstractList<E> implements List<E> 
{
    ...
    // post: appends all values in the given list to the end of this list while retaining the integrity of the other.
    ...
    //is doubly-linked to start from the front or the back, whichever is closer.
    ...
    //Inner class of LinkedList that handles the compilation of ListNodes for LinkedList to use.
    ...
    //Inner class of LinkedList that handles the iterator for LinkedList
